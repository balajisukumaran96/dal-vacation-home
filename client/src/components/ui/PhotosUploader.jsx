...
const S3_BUCKET = import.meta.env.VITE_S3_BUCKET || 'dalvacation-home-profile';
const REGION = import.meta.env.VITE_AWS_REGION || 'us-east-1';
const IDENTITY_POOL_ID = import.meta.env.VITE_AWS_IDENTITY_POOL_ID;

// Use Cognito for authentication instead of hardcoded credentials
const s3 = new S3Client({
  region: REGION,
  credentials: IDENTITY_POOL_ID ? fromCognitoIdentityPool({
